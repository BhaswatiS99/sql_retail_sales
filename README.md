...
3. **Retrieve all transactions where the category is 'Clothing' and the quantity sold is more than 4 in the month of Nov-2022:**
...
```sql
SELECT category, ROUND(AVG(age)) FROM retail_sales    # ROUND- Convert the float value to INT
...
## Author - Bhaswati Saikia

This project is part of my portfolio, showcasing the SQL skills essential for data analyst roles. If you have any questions, feedback, or would like to collaborate, feel free to get in touch!

Email- bhaswatisaikia74@gmail.com
